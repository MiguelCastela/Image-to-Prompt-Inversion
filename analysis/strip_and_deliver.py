...
FILES = ["src/vlm_caption.py", "src/phase1_interrogate.py", "src/phase2_sampling.py",
         "src/phase3_render_score.py", "src/phase4_refine.py", "src/evaluation.py",
         "src/phase4_aggregate_seeds.py"]
...
for fn in FILES:
    ...
    (OUT / Path(fn).name).write_text(stripped)
    o, s = orig.count("\n"), stripped.count("\n")
